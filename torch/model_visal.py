...
class ModelSpatial(nn.Module):
    ...
    def forward(self, images, depth, head, face, face_depth, gaze_field, eye, device):
        ...
        model_all_images['gaze_field_map_1'] = gaze_field_map

        # mask with gaze_field
        gaze_field_map_2 = torch.pow(gaze_field_map, 3)
        model_all_images['gaze_field_map_2'] = gaze_field_map_2
        gaze_field_map_3 = torch.pow(gaze_field_map, 5)
        model_all_images['gaze_field_map_3'] = gaze_field_map_3
        ...
        model_all_images['depth_offset'] = depth
        model_all_images['face_depth_offset'] = face_depth
        ...
        return x, torch.mean(attn_weights, 1, keepdim=True), encoding_inout, direction, gaze_field_map, model_all_images
